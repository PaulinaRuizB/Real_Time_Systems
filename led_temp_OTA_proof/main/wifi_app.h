...
// Credenciales de tu router de casa (la red a la que se conecta como Station)
#define WIFI_STA_SSID        "JENNIFER"   // El nombre de tu red de casa
#define WIFI_STA_PASSWORD    "28862008"        // La contraseña de tu red de casa
